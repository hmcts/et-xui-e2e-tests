...
module.exports = {
  ...
  async getClaimantFirstName() {
   ...
   await I.click('[aria-posinset="2"] > .mat-tab-label-content');
    const firstName = await I.grabTextFrom('#case-viewer-field-read--claimantIndType tr:nth-of-type(2) span:nth-of-type(1) span:nth-of-type(1)');
    const lastName = await I.grabTextFrom('#case-viewer-field-read--claimantIndType tr:nth-of-type(3) span:nth-of-type(1) span:nth-of-type(1)');
