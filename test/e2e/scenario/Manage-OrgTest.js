...
Scenario('Verify Assigned Cases for England and Wales', async ({ I, manageOrgPage, loginPage }) => {
  I.amOnPage(testConfig.TestUrlForManageOrg);
  await loginPage.processLoginOnXui(testConfig.TestEnvETManageOrgSuperUserName, testConfig.TestEnvETManageOrgSuperPassword);
